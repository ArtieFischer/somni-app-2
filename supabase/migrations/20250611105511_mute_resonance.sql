-- supabase/migrations/20250107120000_add_transcription_fields.sql
...
CREATE TABLE IF NOT EXISTS public.transcription_usage (
  ...
  -- Indexes for queries
  CONSTRAINT transcription_usage_user_id_idx INDEX (user_id),
  CONSTRAINT transcription_usage_created_at_idx INDEX (created_at)
);
